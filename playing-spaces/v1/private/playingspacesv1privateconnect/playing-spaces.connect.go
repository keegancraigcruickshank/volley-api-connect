...
import (
	...
	private "github.com/keegancraigcruickshank/volley-api-connect/playingspaces/v1/private"
	http "net/http"
	strings "strings"
)
...
const (
	...
	// service.
	PrivatePlayingSpacesServiceName = "playingspaces.v1.private.PrivatePlayingSpacesService"
)
...
const (
	...
	PrivatePlayingSpacesServiceListPlayingSpacesProcedure = "/playingspaces.v1.private.PrivatePlayingSpacesService/ListPlayingSpaces"
	...
	PrivatePlayingSpacesServiceCreatePlayingSpaceProcedure = "/playingspaces.v1.private.PrivatePlayingSpacesService/CreatePlayingSpace"
	...
	PrivatePlayingSpacesServiceRemovePlayingSpacesProcedure = "/playingspaces.v1.private.PrivatePlayingSpacesService/RemovePlayingSpaces"
	...
	PrivatePlayingSpacesServiceModifyPlayingSpaceProcedure = "/playingspaces.v1.private.PrivatePlayingSpacesService/ModifyPlayingSpace"
)

// PrivatePlayingSpacesServiceClient is a client for the
// playingspaces.v1.private.PrivatePlayingSpacesService service.
...
// playingspaces.v1.private.PrivatePlayingSpacesService service. By default, it uses the Connect
...
// ListPlayingSpaces calls playingspaces.v1.private.PrivatePlayingSpacesService.ListPlayingSpaces.
...
// CreatePlayingSpace calls playingspaces.v1.private.PrivatePlayingSpacesService.CreatePlayingSpace.
...
// playingspaces.v1.private.PrivatePlayingSpacesService.RemovePlayingSpaces.
...
// ModifyPlayingSpace calls playingspaces.v1.private.PrivatePlayingSpacesService.ModifyPlayingSpace.
...
func NewPrivatePlayingSpacesServiceHandler(svc PrivatePlayingSpacesServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/playingspaces.v1.private.PrivatePlayingSpacesService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPrivatePlayingSpacesServiceHandler) ListPlayingSpaces(context.Context, *connect_go.Request[private.ListPlayingSpacesRequest]) (*connect_go.Response[private.ListPlayingSpacesResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("playingspaces.v1.private.PrivatePlayingSpacesService.ListPlayingSpaces is not implemented"))
}
...
func (UnimplementedPrivatePlayingSpacesServiceHandler) CreatePlayingSpace(context.Context, *connect_go.Request[private.CreatePlayingSpaceRequest]) (*connect_go.Response[private.CreatePlayingSpaceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("playingspaces.v1.private.PrivatePlayingSpacesService.CreatePlayingSpace is not implemented"))
}
...
func (UnimplementedPrivatePlayingSpacesServiceHandler) RemovePlayingSpaces(context.Context, *connect_go.Request[private.RemovePlayingSpacesRequest]) (*connect_go.Response[private.RemovePlayingSpacesResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("playingspaces.v1.private.PrivatePlayingSpacesService.RemovePlayingSpaces is not implemented"))
}
...
func (UnimplementedPrivatePlayingSpacesServiceHandler) ModifyPlayingSpace(context.Context, *connect_go.Request[private.ModifyPlayingSpaceRequest]) (*connect_go.Response[private.ModifyPlayingSpaceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("playingspaces.v1.private.PrivatePlayingSpacesService.ModifyPlayingSpace is not implemented"))
}
