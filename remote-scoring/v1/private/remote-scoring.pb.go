...
type ListScoresRequest struct {
	...
	Filter   *ListScoresFilter `protobuf:"bytes,4,opt,name=filter,proto3,oneof" json:"filter,omitempty"`
}
...
var file_remote_scoring_v1_private_remote_scoring_proto_rawDesc = []byte{
	...
	0x48, 0x0a, 0x06, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32,
