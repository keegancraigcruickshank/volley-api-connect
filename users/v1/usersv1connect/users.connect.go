...
func (c *usersServiceClient) Login(ctx context.Context, req *connect_go.Request[v1.LoginRequest]) (*connect_go.Response[v1.LoginResponse], error) {
	return c.login.CallUnary(ctx, req)
}

// RefreshToken calls users.v1.UsersService.RefreshToken.
func (c *usersServiceClient) RefreshToken(ctx context.Context, req *connect_go.Request[v1.RefreshTokenRequest]) (*connect_go.Response[v1.RefreshTokenResponse], error) {
...
func NewUsersServiceHandler(svc UsersServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/users.v1.UsersService/Login", connect_go.NewUnaryHandler(
		"/users.v1.UsersService/Login",
		svc.Login,
		opts...,
	))
	mux.Handle("/users.v1.UsersService/RefreshToken", connect_go.NewUnaryHandler(
		"/users.v1.UsersService/RefreshToken",
		svc.RefreshToken,
		opts...,
	))
...
func (UnimplementedUsersServiceHandler) Login(context.Context, *connect_go.Request[v1.LoginRequest]) (*connect_go.Response[v1.LoginResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("users.v1.UsersService.Login is not implemented"))
}

func (UnimplementedUsersServiceHandler) RefreshToken(context.Context, *connect_go.Request[v1.RefreshTokenRequest]) (*connect_go.Response[v1.RefreshTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("users.v1.UsersService.RefreshToken is not implemented"))
}
