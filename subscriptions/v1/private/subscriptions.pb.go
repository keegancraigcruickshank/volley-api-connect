...
var file_subscriptions_v1_private_subscriptions_proto_goTypes = []interface{}{
...
func file_subscriptions_v1_private_subscriptions_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_subscriptions_v1_private_subscriptions_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_subscriptions_v1_private_subscriptions_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_subscriptions_v1_private_subscriptions_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
